...
object ValueOps {
    ...
    def plus(v1: Value, v2: Value): Value = (v1, v2) match {
        ...
        case _ => throw new IllegalArgumentException("Cannot plus figures, numbers and closures")
    }
    ...
    def mult(v1: Value, v2: Value): Value = (v1, v2) match {
        ...
        case _ => throw new IllegalArgumentException("Cannot mult figures, numbers and closures")
    }
    ...
    def div(v1: Value, v2: Value): Value = (v1, v2) match {
        ...
        case (FigValue(f1), NumValue(f2)) =>
            FigValue(f1.rotate(f2))
        case _ => throw new IllegalArgumentException("Cannot div figures, numbers and closures")
    }
